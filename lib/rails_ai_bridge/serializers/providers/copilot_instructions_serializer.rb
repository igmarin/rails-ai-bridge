...
module RailsAiBridge
  module Serializers
    module Providers
      # Generates `.github/instructions/*.instructions.md` files with `applyTo` front matter
      # for GitHub Copilot path-scoped instructions.
      class CopilotInstructionsSerializer
        ...
        # @return [String, nil] Models instruction markdown, or +nil+ if no models.
        ...
        # @return [String, nil] Controllers instruction markdown, or +nil+ if none.
        ...
        # @return [String] Global MCP tools instruction file (`applyTo: "**/*"`).
