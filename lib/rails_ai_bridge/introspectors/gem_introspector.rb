...
module RailsAiBridge
  module Introspectors
    ...
    class GemIntrospector
      ...
      NOTABLE_GEMS = {
        # Auth
        'devise' => { category: :auth,
                      note: 'Authentication via Devise. Check User model for devise modules.' },
        ...
        # Frontend
        'turbo-rails' => { category: :frontend,
                           note: 'Hotwire Turbo for SPA-like navigation. Check Turbo Streams and Frames.' },
        'stimulus-rails' => { category: :frontend, note: 'Stimulus.js controllers in app/javascript/controllers/.' },
        'importmap-rails' => { category: :frontend,
                               note: 'Import maps for JS (no bundler). Check config/importmap.rb.' },
        'jsbundling-rails' => { category: :frontend,
                                note: 'JS bundling (esbuild/webpack/rollup). Check package.json.' },
        'cssbundling-rails' => { category: :frontend,
                                 note: 'CSS bundling. Check package.json for Tailwind/PostCSS/etc.' },
