...
module RailsAiBridge
  module Tools
    ...
    class GetStimulus < BaseTool
      ...
      description 'Get Stimulus controller information including targets, values, actions, outlets, and classes.
      Optionally filter by controller name.'
      ...
      input_schema(
        properties: {
          ...
          detail: {
            ...
            description: 'Detail level for controller listings. summary: counts. standard: names plus targets/actions.
            full: everything.'
          }
        }
      )
